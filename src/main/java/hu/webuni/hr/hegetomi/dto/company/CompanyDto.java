...
public class CompanyDto {
    ...
    public CompanyDto(long id, long registrationNumber, String name, String address, CompanyTypeDto type, List<EmployeeDto> employees, List<CompanyPositionSalaryDto> availablePositions) {
        this.id = id;
